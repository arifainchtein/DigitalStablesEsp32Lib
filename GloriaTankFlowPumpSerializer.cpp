...
void GloriaTankFlowPumpSerializer::pushToSerial(HardwareSerial &serial, GloriaTankFlowPumpData &gloriaTankFlowPumpData)
{
  ...
  {
    if (gloriaTankFlowPumpData.deviceTypeId[i] != NULL)
  ...
  {
    if (gloriaTankFlowPumpData.serialnumberarray[i] != NULL)
      Serial.print(gloriaTankFlowPumpData.serialnumberarray[i], HEX);
  }
  serial.print(F("#"));
  ...
  {
    if (gloriaTankFlowPumpData.flow1name[i] != NULL)
  ...
  {
    if (gloriaTankFlowPumpData.flow2name[i] != NULL)
  ...
  {
    if (gloriaTankFlowPumpData.tank1name[i] != NULL)
  ...
  {
    if (gloriaTankFlowPumpData.tank2name[i] != NULL)
